...
:page-product: cloud
:page-categories: Caching, Kubernetes
:page-lang: go, java, node, python
:page-est-time: 5-10 mins
:framework: Kubernetes Operator
:description: This tutorial will explain how to use the Expose Externally feature of Hazelcast Platform Operator to connect to Hazelcast clusters running on Kubernetes from outside.
...
- xref:hazelcast-platform-operator.adoc[]
